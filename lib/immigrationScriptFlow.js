...
const voicemailCompletionButtons = [
  ["Sent voicemail", "voicemail_sent"],
  ["Send email too", "voicemail_email"],
  ["Schedule callback", "voicemail_callback"],
  ["Mark as voicemail left", "voicemail_logged"],
  ["Retry later", "voicemail_callback"]
];
...
export const immigrationScriptStates = {
  call_start: {
    ...
    notes: "Choose the call result as soon as you know it. All four initial paths are ready for live use.",
    buttons: buttons([
      ["Secretary / Receptionist", "secretary_opening"],
      ["Paralegal", "paralegal_opening"],
      ["Attorney", "attorney_opening"],
      ["No Response / Voicemail", "voicemail_no_answer"]
    ])
  },
  secretary_opening: {
  ...
  secretary_transfer: {
    ...
    buttons: buttons([
      ...
      ["Sent to voicemail", "voicemail_leave_menu"],
  ...
  voicemail_no_answer: {
    id: "voicemail_no_answer",
    title: "No Answer",
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Determine the next action.",
    script: "No one answered. Choose the most accurate outcome or next step.",
    notes:
      "Move quickly and log accurately. A no-answer attempt should end with either a message, a timed retry, another channel, or clean data hygiene.",
    buttons: buttons([
      ["Leave voicemail", "voicemail_leave_menu"],
      ["Call back later", "voicemail_callback"],
      ["Send email", "voicemail_email"],
      ["Double call", "voicemail_double_call"],
      ["Wrong number", "voicemail_wrong_number"],
      ["Automated directory", "voicemail_directory"],
      ["Busy line", "voicemail_busy"],
      ["Disconnect / dead number", "voicemail_dead_number"]
    ])
  },
  voicemail_leave_menu: {
    id: "voicemail_leave_menu",
    title: "Leave Voicemail",
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Select a concise message appropriate to this attempt.",
    script: "Choose the voicemail style that matches the context of this call.",
    notes:
      "Keep it calm and short. Establish legitimacy, create relevance, state a callback number clearly, then stop.",
    buttons: buttons([
      ["Ultra short voicemail", "voicemail_ultra_short"],
      ["Standard voicemail", "voicemail_standard"],
      ["Technical / legal voicemail", "voicemail_technical"],
      ["Warm callback voicemail", "voicemail_warm"],
      ["Follow-up voicemail", "voicemail_followup"],
      ["Second attempt voicemail", "voicemail_second_attempt"]
    ])
  },
  voicemail_ultra_short: {
    id: "voicemail_ultra_short",
    title: "Ultra Short Voicemail",
    audience: "No Response / Voicemail",
    goal: "Leave a compact callback message.",
    script:
      "Hi, this is [REP NAME] from Coverable. We work with immigration law firms on petition drafting and filing packet automation. Wanted to briefly connect. My number is [NUMBER]. Again, [NUMBER].",
    notes: "Best when the mailbox seems likely to cut off longer messages.",
    buttons: buttons(voicemailCompletionButtons)
  },
  voicemail_standard: {
    id: "voicemail_standard",
    title: "Standard Voicemail",
    audience: "No Response / Voicemail",
    goal: "Leave a professional first-touch message.",
    script:
      "Hi, this is [REP NAME] from Coverable. We work with immigration law firms to automate immigration packet preparation, including cover letters, legal arguments, and exhibit organization. I thought the platform might be relevant for your team and wanted to briefly introduce it. My callback number is [NUMBER]. Again, that's [NUMBER].",
    notes: "Use for a first attempt when relevance needs one brief sentence.",
    buttons: buttons(voicemailCompletionButtons)
  },
  voicemail_technical: {
    id: "voicemail_technical",
    title: "Technical / Legal Voicemail",
    audience: "No Response / Voicemail",
    goal: "Signal substantive relevance to a technical or attorney audience.",
    script:
      "Hi, this is [REP NAME] from Coverable. We built a workflow platform for immigration firms that automates drafting and filing-ready packet assembly using source-document-driven workflows. I thought it might be relevant to your practice. My number is [NUMBER].",
    notes: "Use when reaching an attorney or legal operations contact.",
    buttons: buttons(voicemailCompletionButtons)
  },
  voicemail_warm: {
    id: "voicemail_warm",
    title: "Warm Callback Voicemail",
    audience: "No Response / Voicemail",
    goal: "Create curiosity without overselling.",
    script:
      "Hi, this is [REP NAME] from Coverable. We've been speaking with immigration firms about reducing repetitive petition drafting and exhibit assembly work, and I thought it made sense to reach out. My callback number is [NUMBER].",
    notes: "Use a natural, composed tone. Do not imply an existing relationship.",
    buttons: buttons(voicemailCompletionButtons)
  },
  voicemail_followup: {
    ...
    audience: "No Response / Voicemail",
    goal: "Reference prior outreach and coordinate an email.",
    script:
      "Hi, this is [REP NAME] from Coverable following up briefly. We work with immigration firms on drafting automation and filing packet workflows. I'll also send over a short email for context. My number is [NUMBER].",
    notes: "Use after an earlier call or email attempt. Send the promised email promptly.",
    buttons: buttons(voicemailCompletionButtons)
  },
  voicemail_second_attempt: {
    id: "voicemail_second_attempt",
    title: "Second Attempt Voicemail",
    audience: "No Response / Voicemail",
    goal: "Leave a short second-touch message.",
    script:
      "Hi, this is [REP NAME] from Coverable following up briefly. We work with immigration firms on drafting automation and filing packet workflows. I'll also send over a short email for context. My number is [NUMBER].",
    notes: "A second attempt should be shorter, not more insistent.",
    buttons: buttons(voicemailCompletionButtons)
  },
  voicemail_sent: {
    id: "voicemail_sent",
    ...
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Choose the coordinated next step.",
    script: "Voicemail complete. Choose the next outreach action and record the disposition.",
    notes: "A short email after a voicemail can add context without repeating a full pitch.",
    buttons: buttons([
      ["Send email too", "voicemail_email"],
      ["Schedule callback", "voicemail_callback"],
      ["Mark as voicemail left", "voicemail_logged"],
      ["Sequence complete", "voicemail_complete"]
    ])
  },
  voicemail_logged: {
    id: "voicemail_logged",
    ...
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Record the attempt and plan any next activity.",
    script: "Mark voicemail left in CRM, including message type and next follow-up step.",
    notes: "Accurate disposition tracking matters for outreach cadence and coaching.",
    buttons: buttons([
      ["Schedule retry", "voicemail_callback"],
      ["Send follow-up email", "voicemail_email"],
      ["Complete attempt", "voicemail_complete"]
    ])
  },
  voicemail_callback: {
    ...
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Schedule intelligent retry logic.",
    script: "Select the next call window and log it as a follow-up activity.",
    notes:
      "Attorneys are often more reachable early or late in the workday. Avoid lunch hours and avoid relying on Monday morning as your primary retry window.",
    buttons: buttons([
      ["Retry in 1 hour", "voicemail_retry_scheduled"],
      ["Retry this afternoon", "voicemail_retry_scheduled"],
      ["Retry tomorrow morning", "voicemail_retry_scheduled"],
      ["Retry tomorrow afternoon", "voicemail_retry_scheduled"],
      ["Retry next week", "voicemail_retry_scheduled"],
      ["Randomized retry", "voicemail_retry_scheduled"],
      ["Different rep retry", "voicemail_retry_scheduled"]
    ])
  },
  voicemail_retry_scheduled: {
    id: "voicemail_retry_scheduled",
    title: "Retry Scheduled",
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Confirm a timed follow-up is recorded.",
    script: "Retry selected. Log the time, call disposition, and any companion email before moving on.",
    notes: "A specific retry window is better than repeatedly redialing without a plan.",
    buttons: buttons([
      ["Send email also", "voicemail_email"],
      ["Complete attempt", "voicemail_complete"],
      ["Start next call", "call_start"]
    ])
  },
  voicemail_email: {
    id: "voicemail_email",
    ...
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Coordinate another outreach channel.",
    script: "Choose the email type to pair with this call attempt.",
    notes: "This version records the workflow choice; email composition can be added later.",
    buttons: buttons([
      ["Send immediate email", "voicemail_email_action"],
      ["Email after voicemail", "voicemail_email_action"],
      ["Send short intro email", "voicemail_email_action"],
      ["Send technical email", "voicemail_email_action"],
      ["Send demo-focused email", "voicemail_email_action"]
    ])
  },
  voicemail_email_action: {
    id: "voicemail_email_action",
    title: "Email Selected",
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Complete or schedule the coordinated sequence.",
    script: "Send the selected email and record the next follow-up action.",
    notes: "Keep outbound messaging aligned with the same packet-preparation value proposition.",
    buttons: buttons([
      ["Email sent", "voicemail_email_sent"],
      ["Schedule follow-up call", "voicemail_callback"],
      ["Wait for response", "voicemail_waiting"],
      ["Mark sequence complete", "voicemail_complete"]
    ])
  },
  voicemail_email_sent: {
    id: "voicemail_email_sent",
    title: "Email Sent",
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Choose the next action after outreach.",
    script: "Email sent. Schedule the next activity or close this attempt.",
    notes: "Do not let an email remove the need for deliberate follow-up.",
    buttons: buttons([
      ["Schedule follow-up call", "voicemail_callback"],
      ["Wait for response", "voicemail_waiting"],
      ["Sequence complete", "voicemail_complete"]
  ...
  voicemail_waiting: {
    id: "voicemail_waiting",
    title: "Waiting for Response",
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Set a disciplined follow-up checkpoint.",
    script: "Record the outreach and create a follow-up reminder before moving to the next firm.",
    notes: "Waiting without a reminder creates lost opportunities.",
    buttons: buttons([
      ["Schedule follow-up", "voicemail_callback"],
      ["Complete attempt", "voicemail_complete"]
    ])
  },
  voicemail_double_call: {
    id: "voicemail_double_call",
    title: "Double Call",
    audience: "No Response / Voicemail",
    goal: "Handle a second immediate attempt professionally if someone answers.",
    script: "Sorry about that, I think we got disconnected. This is [REP NAME] from Coverable.",
    notes: "Many offices assume a second call may be important or internal. Use this sparingly and keep your tone matter-of-fact.",
    buttons: buttons([
      ["Secretary answered", "secretary_opening"],
      ["Paralegal answered", "paralegal_opening"],
      ["Attorney answered", "attorney_opening"],
      ["Voicemail again", "voicemail_leave_menu"],
      ["No answer again", "voicemail_callback"]
    ])
  },
  voicemail_wrong_number: {
    id: "voicemail_wrong_number",
    title: "Wrong Number",
    audience: "No Response / Voicemail",
    goal: "Recover routing when a person answers the incorrect line.",
    script:
      "No worries at all. Would you happen to know the best number for the immigration department or office manager?",
    notes: "Ask once politely. Do not continue pitching someone outside the target office.",
    buttons: buttons([
      ["Gives new number", "voicemail_new_number"],
      ["Doesn't know", "voicemail_complete"],
      ["Hangs up", "voicemail_complete"],
      ["Refuses", "voicemail_complete"]
    ])
  },
  voicemail_new_number: {
    id: "voicemail_new_number",
    title: "New Number Captured",
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Log corrected contact information.",
    script: "Record the updated number and create a new call attempt for the correct office contact.",
    notes: "Correct data before dialing again so future attempts use the right route.",
    buttons: buttons([
      ["Call new number", "call_start"],
      ["Schedule new attempt", "voicemail_callback"],
      ["Complete update", "voicemail_complete"]
    ])
  },
  voicemail_directory: {
    id: "voicemail_directory",
    title: "Automated Directory",
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Choose the strongest automated routing path.",
    script: "Select the most relevant directory action available on the phone tree.",
    notes:
      "Operators are usually the highest-probability route. Direct extensions are strongest when known. Avoid generic mailboxes if a person or relevant department is available.",
    buttons: buttons([
      ["Press attorney extension", "attorney_opening"],
      ["Press operator", "secretary_opening"],
      ["Press immigration department", "voicemail_directory_connected"],
      ["Press office manager", "secretary_opening"],
      ["Use dial-by-name", "voicemail_directory_connected"],
      ["Leave voicemail", "voicemail_leave_menu"],
      ["Hang up and retry", "voicemail_callback"]
    ])
  },
  voicemail_directory_connected: {
    id: "voicemail_directory_connected",
    title: "Directory Connected",
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Identify who picks up after directory routing.",
    script: "The call connected through the directory. Choose who answered.",
    notes: "Reset cleanly into the appropriate live conversation opener.",
    buttons: buttons([
      ["Secretary / Receptionist", "secretary_opening"],
      ["Paralegal", "paralegal_opening"],
      ["Attorney", "attorney_opening"],
      ["Voicemail", "voicemail_leave_menu"],
      ["No answer", "voicemail_callback"]
    ])
  },
  voicemail_busy: {
    id: "voicemail_busy",
    ...
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Retry intelligently.",
    script: "The line is busy. Choose a measured retry action.",
    notes: "An immediate retry can make sense once; repeated fast redials create noise.",
    buttons: buttons([
      ["Retry immediately", "voicemail_double_call"],
      ["Retry in 5 minutes", "voicemail_retry_scheduled"],
      ["Retry later today", "voicemail_retry_scheduled"],
      ["Schedule callback", "voicemail_callback"]
    ])
  },
  voicemail_dead_number: {
    id: "voicemail_dead_number",
    title: "Disconnected Number",
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Protect data quality.",
    script: "The phone number is disconnected or unusable. Choose the correct data-hygiene action.",
    notes: "Do not continue retrying a dead number. Correct or retire the record.",
    buttons: buttons([
      ["Mark invalid number", "voicemail_invalid_number"],
      ["Search alternate number", "voicemail_research"],
      ["Search website", "voicemail_research"],
      ["Search LinkedIn", "voicemail_research"],
      ["Skip firm", "voicemail_complete"],
      ["Manual review", "voicemail_manual_review"]
    ])
  },
  voicemail_invalid_number: {
    id: "voicemail_invalid_number",
    title: "Mark Invalid Number",
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Remove unusable dialing data.",
    script: "Mark this phone number invalid and note the reason before taking another action.",
    notes: "Invalid contact data should not remain in future calling lists.",
    buttons: buttons([
      ["Search alternate number", "voicemail_research"],
      ["Manual review", "voicemail_manual_review"],
      ["Complete attempt", "voicemail_complete"]
  ...
  voicemail_research: {
    id: "voicemail_research",
    title: "Find Alternate Contact",
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Create a clean research follow-up.",
    script: "Create a task to verify a current firm number or contact route before the next call.",
    notes: "Do not guess replacement contact details during rapid dial sessions.",
    buttons: buttons([
      ["New number found", "voicemail_new_number"],
      ["Route not found", "voicemail_manual_review"],
      ["Skip firm", "voicemail_complete"]
    ])
  },
  voicemail_manual_review: {
    id: "voicemail_manual_review",
    title: "Manual Review",
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Flag records requiring human data cleanup.",
    script: "Flag this firm for manual contact review and stop dialing this number.",
    notes: "Prevent repeated low-quality attempts against bad data.",
    buttons: buttons([
      ["Complete attempt", "voicemail_complete"],
      ["Start next call", "call_start"]
    ])
  ...
  voicemail_complete: {
    id: "voicemail_complete",
    title: "Attempt Complete",
    audience: "No Response / Voicemail",
    mode: "prompt",
    goal: "Log the result and move to the next call.",
    script: "Log the outcome, next scheduled action, and contact data status in CRM.",
    notes: "Close the loop while the attempt is still fresh.",
    buttons: buttons([
      ["Start next call", "call_start"],
      ["Return to CRM", "call_complete"]
    ])
  }
};
