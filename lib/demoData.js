...
export const initialState = {
  ...
  currentRepId: "maya",
  reps: [
    { id: "maya", name: "Maya Rivera", initials: "MR", startDate: "2026-05-18", role: "admin" },
  ...
  scriptCalls: [
    {
      ...
      buttonClicks: 5,
      responses: [
        { response: "Secretary / Receptionist" },
        { response: "What is this regarding?" },
        { response: "Send email" },
        { response: "Attorney email provided" },
        { response: "Schedule follow-up" }
      ],
    ...
    },
    {
      ...
      responses: [
        { response: "Attorney" },
        { response: "We already have software" },
        { response: "Uses Docketwise" },
        { response: "Interested" },
        { response: "Book demo" },
        { response: "Captured email" },
        { response: "End call" }
      ],
      practiceArea: "immigration",
    ...
    },
    {
      ...
      repId: "eli",
      buttonClicks: 2,
      responses: [{ response: "Secretary / Receptionist" }, { response: "They're busy" }],
      practiceArea: "immigration",
      createdAt: "2026-05-23"
    },
    {
      ...
      responses: [
        { response: "Paralegal" },
        { response: "Yes, I prepare packets" },
  ...
  firms: [
    {
      id: "f1",
      attorney: "Margaret D. Stock",
      firmName: "Cascadia Cross Border Law Group LLC",
      practiceArea: "immigration",
      website: "https://cascadialawalaska.com",
      phone: "19072425800",
      email: "mstock@cascadialawalaska.com",
      city: "Anchorage",
      state: "AK",
      outreachTier: "T0",
      emailValid: true,
    ...
    {
      id: "f2",
      attorney: "Michael Romeo Tamou",
      firmName: "Tamou Law Group",
      practiceArea: "criminal_defense",
      website: "https://tamoulawgroup.com",
      phone: "16233214699",
      email: "",
      linkedinUrl: "https://www.linkedin.com/in/michael-tamou-680218120",
      title: "Attorney",
      address: "9375 E Shea Blvd Suite",
      city: "Scottsdale",
      state: "AZ",
      outreachTier: "T3",
      emailValid: false,
      confidenceScore: 88,
      laneTarget: "law",
      notes: "Sourced from firm website.",
      dataSources: "Website and LinkedIn",
      calledBy: null,
      calledAt: "",
      callCount: 0
    },
    {
      id: "f3",
      attorney: "Angel Raymond",
      firmName: "AA Raymond Law",
      practiceArea: "criminal_defense",
      website: "https://aaraymondlaw.com",
      phone: "15209485481",
      email: "office@aaraymondlaw.com",
      city: "Casa Grande",
      state: "AZ",
      outreachTier: "T0",
      emailValid: true,
